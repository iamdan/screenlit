  ...
  <div id="main-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?> clearfix">
	 <?php if($messages || $page['help']): ?>
	  ...
	  <!-- //HELP & MESSAGES -->
	  <?php endif; ?>
      <div class="container-inner clearfix <?php print nucleus_group_class("content, sidebar_second");?> ">
      ...
      <div class="container-inner clearfix <?php print nucleus_group_class("content, sidebar_second");?> ">
        ...
        <div id="main-content-wrapper" class="<?php print nucleus_group_class("content");?>"> 
          <!-- MAIN CONTENT -->
          ...
          <div class="mass-bottom <?php print nucleus_group_class("content");?>">
            <div class="grid-inner clearfix"> <?php print($mass_bottom);?> </div>
          </div>
          <?php endif; ?>
          <!-- //MASS BOTTOM --> 
    ...
    <div id="breadcrumb-wrapper" class="wrapper">
      <div class="container <?php print $grid;?>">
          ...
          <?php if ($back_to_top_display): ?>
            <a title="<?php print t('Back to Top')?>" class="btn-top" href="#Top"><?php print t('Top')?></a>
          <?php endif; ?>
          </div>
      </div>
    </div>
