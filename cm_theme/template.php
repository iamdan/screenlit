...
function cm_theme_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['theme_settings']['logo_link_override'] = array(
    '#type' => 'textfield',
    '#title' => t('Override Logo Link'),
    '#default_value' => theme_get_setting('logo_link_override'),
    '#description' => t('By default the logo links to the site root.  When using Bakery to create subsites, use this to override the logo link.'),
  );
}
